...
struct Z_CompiledInDeferFile_FID_FrameworkSample_Plugins_GameFeatures_BuildSystem_Source_BuildSystemRuntime_Public_TestStaticMeshComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTestStaticMeshComponent, UTestStaticMeshComponent::StaticClass, TEXT("UTestStaticMeshComponent"), &Z_Registration_Info_UClass_UTestStaticMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestStaticMeshComponent), 1466234038U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FrameworkSample_Plugins_GameFeatures_BuildSystem_Source_BuildSystemRuntime_Public_TestStaticMeshComponent_h_2492586864(TEXT("/Script/BuildSystemRuntime"),
