...
struct Z_CompiledInDeferFile_FID_FrameworkSample_Plugins_GameFeatures_BuildSystem_Source_BuildSystemRuntime_Public_BuildRuntimeComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBuildRuntimeComponent, UBuildRuntimeComponent::StaticClass, TEXT("UBuildRuntimeComponent"), &Z_Registration_Info_UClass_UBuildRuntimeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBuildRuntimeComponent), 410566267U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FrameworkSample_Plugins_GameFeatures_BuildSystem_Source_BuildSystemRuntime_Public_BuildRuntimeComponent_h_1699055486(TEXT("/Script/BuildSystemRuntime"),
